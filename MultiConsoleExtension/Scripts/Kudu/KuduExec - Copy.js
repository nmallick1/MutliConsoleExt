...
function LoadConsole() {
    ...
    function RemoteExecuteCommandRequest(command, workingDirectory) {
		//Pass the ARRAffinity Cookie : d780c9e94a82b6954a9ad015dcefd15c70fed77bc9a1ef2d3ac485ddacc7edeb
		//Figure out a way to get the Publish Credentials and base64 encode it in JavaScript
        var uri = "https://nmallick1.scm.azurewebsites.net/command",
            request = {
                method: "POST",
                contentType: "application/json",
				crossDomain: true,
				beforeSend: function(xhr) {
					xhr.setRequestHeader('Authorization', 'Basic JG5tYWxsaWNrMTp5aU53ZmtKZTBZNjJDanNsUldFTnRsU29DanBqeWUwNG5qRmxtUVJpSnFMd1FrTm1IZTduaFgwbzM3b1A=');
					},
