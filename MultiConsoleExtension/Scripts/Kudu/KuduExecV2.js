...
function LoadConsoleV2() {
	...
	//var connection = $.kuduConnector(appRoot + 'api/commandstream?shell=" + getShell());
	
	var kuduConnection =  kuduExecConsole.kuduConnector({
		URL: appRoot + 'api/commandstream?shell=' + getShell(),
		ARRId: "YYYYYYYY-YYYYYYY",
	...
	console.log("-----------------");
	//console.log(kuduConnection);
	console.log("-----------------");
	kuduConnection.send("C:");
	//kuduConnection.start();
	
    window.$KuduExecConsole.data('connection', kuduConnection);
